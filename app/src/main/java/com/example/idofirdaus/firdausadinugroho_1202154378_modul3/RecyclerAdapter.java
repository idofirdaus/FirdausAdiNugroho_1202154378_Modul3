package com.example.idofirdaus.firdausadinugroho_1202154378_modul3;
    ...
    public void onBindViewHolder(final RecyclerAdapter.ViewHolder holder, final int position) {
        ...
        holder.itemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String descs = " Pada malam hari, tubuh Anda memperbaiki diri dan mengeluarkan semua racun dalam tubuh. Saat minum air pada waktu perut kosong di pagi hari, Anda akan membersihkan racun berbahaya ini, dan membiarkan tubuh Anda segar dan sehat. Minum banyak air dapat membantu meningkatkan produksi sel otot dan sel darah baru.\n" +
                        ...
                        "\n" +
                        "Saat Anda minum air putih di pagi hari ketika perut kosong, Anda akan melepaskan semua racun dan ini akan memperbaiki sistem pencernaan Anda. Anda akan merasa tidak terlalu lapar dan hasrat Anda untuk makan akan berkurang. Hal ini akan mencegah kenaikan berat badan akibat makan berlebih.\n" +
                        "Gangguan pencernaan disebabkan oleh meningkatnya keasaman di perut. Bagi penderita sakit maag, yang akan dirasakan adalah asam lambung kembali ke kerongkongan Anda. Namun, saat Anda minum air putih dengan perut kosong, asam ini bisa ditekan dan diencerkan sehingga bisa mencegah asam lambung Anda naik.\n" +
                        "\n" +
                        "   Dehidrasi menyebabkan keriput dini. Ditemukan dalam sebuah studi bahwa minum 500 ml air pada saat perut kosong meningkatkan aliran darah di kulit dan membuat kulit bersinar. Selain itu, minum lebih banyak air sepanjang hari berarti tubuh Anda semakin banyak mengeluarkan racun, yang akan membuat kulit Anda lebih bercahaya.\n";
                switch (position){
                    case 0:
